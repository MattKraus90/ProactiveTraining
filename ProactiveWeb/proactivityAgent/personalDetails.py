...
class PersonalDetails:
    ...
    def __get_technaff(self):
        technaff = np.array([self.pers_data_dict['TA1'], self.pers_data_dict['TA2'], self.pers_data_dict['TA3'], 
                             self.pers_data_dict['TA4'], self.__convert_val(self.pers_data_dict['TA5']), 
                             self.__convert_val(self.pers_data_dict['TA6'])], dtype=np.float64)
        
        technaff = np.mean(technaff)
        self.pers_data['technical affinity'] = float(np.around(technaff, decimals=0))
    ...
    def __get_managexp(self):
        ...
        self.pers_data['management experience'] = float(np.around(managexp, decimals=0))
    ...
    def __get_neuroticism(self):
        ...
        self.pers_data['neuroticism'] = float(np.around(neuroticism, decimals=0))
    ...
    def __get_extraversion(self):
        ...
        self.pers_data['extraversion'] = float(np.around(extraversion, decimals=0))
    ...
    def __get_agreeableness(self):
        ...
        self.pers_data['agreeableness'] = float(np.around(agreeableness, decimals=0))
    ...
    def __get_conscientiousness(self):
        ...
        self.pers_data['conscientiousness'] = float(np.around(conscientiousness, decimals=0))
