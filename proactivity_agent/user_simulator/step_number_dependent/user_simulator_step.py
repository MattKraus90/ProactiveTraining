...
from user_simulator.step_number_dependent import personalDetails
from user_simulator.step_number_dependent import simData
from user_simulator.step_number_dependent import genPoints
from user_simulator.step_number_dependent import createDataVector
...
class UserSimulator:
    def __init__(self):
        ...
        with open("user_simulator/step_number_dependent/svm_trust_Model.pkl", 'rb') as file:
    ...
    def simulate(self, step_number, action):
        ...
        return self.simulated_data_temp.loc[(0, 'trust' + str(step_number))], self.simulated_data_temp.loc[
            (0, 'points' + str(step_number))], self.simulated_data_temp.loc[(0, 'duration' + str(step_number))]
...
if __name__ == '__main__':
    ...
    for u in range(1, 13):
        trust, points, duration = obj.simulate(u, np.random.choice([0, 1, 2, 3]))
        print('step: ', u, 'trust: ', trust, ' | points: ', points)
