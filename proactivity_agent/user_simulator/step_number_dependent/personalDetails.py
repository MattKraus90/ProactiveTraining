...
class PersonalDetails:
    def __init__(self):
        ...
        try:
            file = open('user_simulator/step_number_dependent/user_simulator_data/dist_data/dist_data_personality.json', 'r')
            ...
            print('Distribution parameter are missing. (personal)')
