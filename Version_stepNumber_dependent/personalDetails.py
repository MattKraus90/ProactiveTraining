...
class PersonalDetails:
    def __init__(self):
        ...
        try:
            ...
            print('Generating distribution values and saving them to file...')
            ...
            file = open('user_simulator_data/dist_data/dist_data_personality.json', 'w')
            json.dump(self.dist_values, file, indent=4, sort_keys=True)
            file.close()
